...
export const statistics = [
	{ id: 1, label: 'Followers', value: user.stats.followers },
	{ id: 2, label: 'Views', value: user.stats.views },
	{ id: 3, label: 'Likes', value: user.stats.likes },
]

export const stats = [
	{ id: 1, label: '.docx', value: '22%' },
	{ id: 2, label: '.pdf', value: '4%' },
	{ id: 3, label: '.mp3', value: '17%' },
	{ id: 4, label: '.psd', value: '47%' },
]
